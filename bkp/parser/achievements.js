...
// const greenluma = require("./greenluma.js");
            ...
            try {
                ...
                try {
                  if (appid.data.type === "file") {
                      ...
                      if(root.constructor === Object && Object.entries(root).length === 0) console.log(`[${appid.appid}] Warning ! Achievement file in '${appid.data.path}' is probably empty`);
