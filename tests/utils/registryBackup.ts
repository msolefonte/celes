...
export async function createKeyBackup(root: string, original_key: string, backup_key: string): Promise<void> {
...
export async function recoverKeyBackup(root: string, original_key: string, backup_key: string): Promise<void> {
